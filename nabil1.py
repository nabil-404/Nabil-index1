...
youtubeid = raw_input("Nabil SaY Ignore It: ")
...
print "\NABIL SAY THIS FILE SAVE AS: index.html"
print "\NABIL SAY USE : mv -v /sdcard/index.html To save file"
